...
public class RoomServiceTest extends BasicRestTest {

    private static final String URL = "http://localhost:" + PORT + APP_URL + "/rest/json/rooms/roomList/get";
    ...
    @Test
    public void testRoomList() throws IOException, SAXException {
...
//        assertEquals("No JSLint issues expected in " + responseString, 0, issues.size());
        ...
        assertTrue("Room expected", responseString.contains("\"name\":\"R0.006\",\"id\":"));
    }
